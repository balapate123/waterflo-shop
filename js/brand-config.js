...
const BRANDS = [
  ...
  },
  {
    ...
    subcategoryNames: {
      ...
      elbow:'Elbow', elbow_lw:'Elbow LW', elbow_equal:'Elbow EQUAL', elbow_bliss:'Elbow BLISS',
      elbow45:'Elbow 45\u00B0', elbow_threaded:'Elbow Threaded',
      tee:'Tee', tee_lw:'Tee LW', tee_equal:'Tee EQUAL', tee_bliss:'Tee BLISS',
      tee_threaded:'Tee Threaded',
      coupler:'Coupler',
      mta:'MTA', mta_bsw:'MTA (BSW Thread)', mta_hex:'MTA (Hex)', reducer_mta:'Reducer MTA',
      fta:'FTA', fta_bsw:'FTA (BSW Thread)', reducing_fta:'Reducing FTA',
      fourway_tee:'Four Way Tee',
      door_elbow:'Door Elbow', door_tee:'Door Tee',
      endcap:'End Cap', endcap_threaded:'End Cap Threaded', endcap_bsw:'End Cap (BSW Thread)',
      single_y:'Single Y', tailpiece:'Tail Piece',
      reducing_tee:'Reducing Tee', reducing_elbow:'Reducing Elbow',
      reducer:'Reducer', reducing_bush:'Reducing Bush',
      service_saddle:'Service Saddle',
      valve:'Ball Valve', longplug:'Long Plug', union:'Union',
      brass_elbow:'Brass Elbow', brass_tee:'Brass Tee', brass_fta:'Brass FTA', brass_mta:'Brass MTA',
  ...
  },
  {
    ...
    subcategoryNames: {
      eco_bore:'ECO BORE', easy_bore:'EASY BORE', medium_bore:'MEDIUM BORE',
      ultra_bore:'ULTRA BORE', standard_bore:'STANDARD BORE', heavy_bore:'HEAVY BORE',
      heavy_plus_bore:'HEAVY PLUS BORE', super_heavy_bore:'SUPER HEAVY BORE',
      eco_bore_be:'ECO BORE (Bell Ended)', easy_bore_be:'EASY BORE (Bell Ended)',
    }
  },
];
